...
type TrafficBroadcastMsg struct {
	// 广播fd
	Fd []int64 `protobuf:"varint,1,rep,packed,name=fd,proto3" json:"fd,omitempty"`
	// 广播地址
	RemoteAddr []string `protobuf:"bytes,2,rep,name=remoteAddr,proto3" json:"remoteAddr,omitempty"`
	// 广播消息
	BroadcastMsg string `protobuf:"bytes,3,opt,name=broadcastMsg,proto3" json:"broadcastMsg,omitempty"`
}
...
func (m *TrafficBroadcastMsg) GetFd() []int64 {
	if m != nil {
		return m.Fd
	}
	return nil
...
var fileDescriptor_90cca7afd8ba4633 = []byte{
	...
	,
}
...
func (m *OpenReq) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Fd != 0 {
		i = encodeVarintServerDto(dAtA, i, uint64(m.Fd))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *TrafficBroadcastMsg) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Fd) > 0 {
		dAtA2 := make([]byte, len(m.Fd)*10)
		var j1 int
		for _, num1 := range m.Fd {
			num := uint64(num1)
			for num >= 1<<7 {
		...
		i = encodeVarintServerDto(dAtA, i, uint64(j1))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *TrafficBroadcastMsg) Size() (n int) {
	...
	if len(m.Fd) > 0 {
		l = 0
		for _, e := range m.Fd {
			l += sovServerDto(uint64(e))
		}
		n += 1 + sovServerDto(uint64(l)) + l
	}
	if len(m.RemoteAddr) > 0 {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 && len(m.Fd) == 0 {
					m.Fd = make([]int64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int64
					for shift := uint(0); ; shift += 7 {
